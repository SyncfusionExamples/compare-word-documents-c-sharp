...
This repository contains examples that illustrates how to compare two DOCX format documents and highlight the changes, such as insertions, deletions, and formatting, as tracked changes programmatically in C#. The [.NET Word Library](https://www.syncfusion.com/document-sdk/net-word-library) (DocIO) compares two Word documents with just few lines of code and also it does not require Microsoft Word application to be installed in the machine.

## Key Features
- [Set Author and Date](https://help.syncfusion.com/document-processing/word/word-library/net/word-document/compare-word-documents#set-author-and-date) - Compare the two Word documents by setting the author and date for revisions to identify the changes.
- [Ignore format changes](https://help.syncfusion.com/document-processing/word/word-library/net/word-document/compare-word-documents#ignore-format-changes) - Compare two Word documents by ignoring the format changes.
...
*   **Documentation:** [Compare Word documents using Syncfusion&reg; Word Library](https://help.syncfusion.com/document-processing/word/word-library/net/word-document/compare-word-documents)
